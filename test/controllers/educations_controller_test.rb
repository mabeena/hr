...
class EducationsControllerTest < ActionController::TestCase
  ...
  test "should create education" do
    assert_difference('Education.count') do
      post :create, education: { completed: @education.completed, concentration: @education.concentration, degree: @education.degree, edate: @education.edate, institution: @education.institution }
    end
  ...
  test "should update education" do
    patch :update, id: @education, education: { completed: @education.completed, concentration: @education.concentration, degree: @education.degree, edate: @education.edate, institution: @education.institution }
    assert_redirected_to education_path(assigns(:education))
  end
